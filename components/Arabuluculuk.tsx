        ...
        <Grid spacing={2} container direction="row" 
          ...
          <Grid item xs={8}>
            ...
            <p>
              ...
              sürecin arabuluculuk olarak tanımlanabilmesi için ise bir üçüncü
              kişinin müdahalesi gereklidir. Kanun, arabuluculuğu <i>“sistematik
              yöntemler uygulayarak, görüşmek ve müzakerelerde bulunmak amacıyla
              tarafları bir araya getiren, onların birbirini anlamaları ve bu
              suretle çözümlerini kendilerinin üretmesini sağlamak için
              aralarında iletişim sürecinin kurulmasını gerçekleştirilen,
          ...
          <Grid item xs={8}>
            ...
            <ul>
              ...
              <li>
                Taraflar arasında korunmaya değer uzun süreli bir (ticari,
                ailevi nitelikte, komşuluk hukuku ile ilgili, kişisel veya uzun
                süreli sözleşme şeklinde bir) ilişki varsa,
              </li>
              <li>
                Uyuşmazlığın görünen tarafları dışında başkaca tarafları da
                varsa,
              </li>
              ...
              <li>
                Uyuşmazlığın yargısal yolla çözümü uyuşmazlığın değerine göre
                çok masraflı olacaksa,
              </li>
              <li>
              ...
              <li>
                Taraflar, uyuşmazlık konusunda gizliliğin korunmasını istiyor
                ise veya
              </li>
              <li>
