...
//               kolaylaştırdığı, çözüme ilişkin karar verme yetkisinin taraflarda
//               kaldığı, sürece ilişkin tavsiye veya karar verme yetkisinin ise
//               üçüncü kişide olduğu bir yapılandırılmış uyuşmazlık çözüm
//               sürecidir. Arabuluculuk için en az iki tarafa ihtiyaç vardır;
//               sürecin arabuluculuk olarak nitelendirilebilmesi için ise bir
//               üçüncü kişinin müdahalesi gereklidir. Bu tarafsız üçüncü kişinin
//               katılımürecin arabuluculuk olarak nitelendirilebilmesi için ise bir
//               üçüncü kişinin müdahalesi gereklidir. Bu tarafsız üçüncü kişinin
//               katılımı olmaksızın yapılan görüşmeler, bir diğer alternatif
//               uyuşmazlık çözüm yolu olan müzakere olacaktır. Bu nedenle,
//               arabuluculuk yöntemine kolaylaştırılmış veya yardımlı müzakere de
//               denilebilir. Arabuluculuk genel anlamıyla, çatışmaların çözümü,
//               yönetimi ve önlenmesi amacıyla kullanılan en etkili yöntem olarak
//               ele alınmakla birlikte, arabuluculuğun temel amacı, mahkemelerin
//               yoğunluğunu azaltmak değil, taraflar arasındaki iletişimsizliği
//               arabuluculuk eğitimi almış profesyoneller yardımıyla gidermektir
//               (madde 7). Kanun, arabuluculuğu “sistematik yöntemler uygulayarak,
//               görüşmek ve müzakerelerde bulunmak amacıyla tarafları bir araya
//               getiren, onların birbirini anlamaları ve bu suretle çözümlerini
//               kendilerinin üretmesini sağlamak için aralarında iletişim
//               sürecinin kurulmasını gerçekleştirilen, uzmanlık eğitimi almış
//               olan tarafsız ve bağımsız bir üçüncü kişinin katılımıyla ve
//               ihtiyari olarak yürütülen uyuşmazlık çözüm yöntemi” olarak
//               tanımlanmaktadır.
//               le alınmakla birlikte, arabuluculuğun temel amacı, mahkemelerin
//               yoğunluğunu azaltmak değil, taraflar arasındaki iletişimsizliği
//               arabuluculuk eğitimi almış profesyoneller yardımıyla gidermektir
//               (madde 7). Kanun, arabuluculuğu “sistematik yöntemler uygulayarak,
//               görüşmek ve müzakerelerde bulunmak amacıyla tarafları bir araya
...
//               olan tarafsız ve bağımsız bir üçüncü kişinin katılımıyla ve
//               ihtiyari olarak yürütülen uyuşmazlık çözüm yöntemi” olarak
//               tanımlanmaktadır.ı olmaksızın yapılan görüşmeler, bir diğer alternatif
//               uyuşmazlık çözüm yolu olan müzakere olacaktır. Bu nedenle,
//               arabuluculuk yöntemine kolaylaştırılmış veya yardımlı müzakere de
//               denilebilir. Arabuluculuk genel anlamıyla, çatışmaların çözümü,
//               yönetimi ve önlenmesi amacıyla kullanılan en etkili yöntem olarak
...
//           height={0}
//           sizes="100vw"
//           style={{ width: "50%", height: "auto", float: "left", margin: "5px" }} // optional
//           alt="Arabuluculuk"
//         />
//         <p>
...
//           Kanun, arabuluculuğu “sistematik yöntemler uygulayarak, görüşmek ve
//           müzakerelerde bulunmak amacıyla tarafları bir araya getiren, onların
//           birbirini anlamaları ve bu suretle çözümlerini kendilerinin üretmesini
//           sağlamak için aralarında iletişim sürecinin kurulmasını
//           gerçekleştirilen, uzmanlık eğitimi almış olan tarafsız ve bağımsız bir
//           üçüncü kişinin katılımıyla ve ihtiyari olarak yürütülen uyuşmazlık
//           çözüm yöntemi” olarak tanımlanmaktadır.
//         </p>
